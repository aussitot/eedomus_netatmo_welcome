...
$webhookurl = str_replace('NW-WebhookRegistration.php','NW-Webhook.php',$my_live_url);
...
if ($debug==true) { error_log(date("d-m-Y H:i:s").' process '.$action.'webhook '.$access_token.'/'.$refresh_token."\n", 3, "NW.log"); }
